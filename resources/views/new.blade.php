                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form id="contactForm" action="{{ url('/guestbook') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <label>Jabatan *</label>
                                    <input type="text" value="{{ old('jabatan') }}" maxlength="100" class="form-control" name="jabatan" id="jabatan" placeholder="Jabatan">
                                </div>

                                <div class="form-group">
                                    <label>Alamat *</label>
                                    <textarea maxlength="500" rows="4" class="form-control" name="alamat" id="alamat" placeholder="Alamat">{{ old('message') }}</textarea>                       
                                </div>

                                <div class="form-group">
                                    <label>No. HP *</label>
                                    <input type="text" value="{{ old('nohp') }}" maxlength="100" class="form-control" name="nohp" id="nohp" placeholder="Nomer HP">
                                </div>
